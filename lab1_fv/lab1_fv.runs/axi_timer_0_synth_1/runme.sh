...
HD_PWD='D:/_code/fv/lab1_fv/lab1_fv.runs/axi_timer_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_timer_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_timer_0.tcl
