...
#
# Script generated by Vivado on Tue Oct 15 18:19:35 +0300 2024
...
#
# Usage        : axi_timer_0.sh
#                axi_timer_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_timer_0.sh [-reset_run]
#                axi_timer_0.sh [-reset_log]
#                axi_timer_0.sh [-help]
#
...
#                script (type 'axi_timer_0.sh -help' for more information).
#
...
design_libs_elab="-libname axi_lite_ipif_v3_0_4 -libname lib_cdc_v1_0_2 -libname lib_pkg_v1_0_3 -libname axi_timer_v2_0_31 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver axi_lite_ipif_v3_0_4 lib_cdc_v1_0_2 lib_pkg_v1_0_3 axi_timer_v2_0_31 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_timer_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_timer_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_timer_0
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_timer_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_timer_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: axi_timer_0.sh [-step]\n\
Usage: axi_timer_0.sh [-lib_map_path]\n\
Usage: axi_timer_0.sh [-reset_run]\n\
Usage: axi_timer_0.sh [-reset_log]\n\
Usage: axi_timer_0.sh [-keep_index]\n\
